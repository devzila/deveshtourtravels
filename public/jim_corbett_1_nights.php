...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Devesh Tour Travels: Jim Corbett Short -Weekend Package  &amp; We provide bus and taxi services for Jim Corbett Short -Weekend Package .</title>
    ...
    <meta property="og:title" content="Devesh Tour Travels: Jim Corbett Short -Weekend Package  &amp; We provide bus and taxi services for Jim Corbett Short -Weekend Package ."/>
    ...
    <meta property="og:image" content="https://deveshtourtravels.com/assets/img/gallery/jim.jpg"/>
    <meta property="og:image:width" content="550"/><meta property="og:image:height" content="370"/>
    <meta property="twitter:image" content="https://deveshtourtravels.com/assets/img/gallery/jim.jpg"/>
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="py-0">
        <div class="bg-holder d-none d-md-block" style="background-image:url(assets/img/gallery/jim.jpg);background-position:right bottom;background-size:contain;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container position-relative">
          <div class="row align-items-center min-vh-75 my-lg-8">
            <div  class="col-md-4 text-center text-md-start py-3">
              <h2 class="mb-4 display">	Jim Corbett Short -Weekend Package :-</h2>
              <p>
                he fable of Edward Jim Corbett is still persisting in the minds and hearts of the people of 
                Garhwal and Kumaon. People all over the world know Jim Corbett from his fabulous writings 
                as a famous hunter who later became the adversary of many notorious man-eaters. There 
                are four biographies on him and three films on his life that displays the lucid accounts of his 
                exploits that he has given in his books.  
        ...
        <div class="container">
          <div class="row flex-center mb-5">
            <div class="col-lg-8 text-center">
              <h1 class="fw-bold fs-md-3 fs-lg-4 fs-xl-5"> Book a Taxi now for your Jim Corbett Short -Weekend Package </h1>
              <hr class="mx-auto text-primary my-4" style="height:3px; width:70px;" />
              <p class="mx-auto">Indulge your spirit of adventure as you join this 03 day Holiday Tour to visit breathtaking 
                parts of Corbett National  Park, far from the usual tourist haunts.  
                </p>
                <p>Tucked away in the foothills of the Himalayan belt, Corbett is a land of striking beauty.  
                  Keep your cameras ready as you have to capture the daring wildlife species found here. 
                  From elusive Royal Bengal Tiger to Leopards, wildlife safari to Corbett Tiger Reserve will be 
                  everlasting and memorable.  Trust us, you will never tire of the sights and sounds and smells of this wondrous land. 
                  This short trip to Corbett is suitable for Corporate outing on a weekend. 
                  </p>
            </div>
          </div>
              <div class="col-12 col-xxl-7 fw-bold fs-2 text-info text-center">
                <p> 
                  Tour Itinerary./ <br>
                  Day 1 ,<br>
                  Arrive in Corbett ./<br> 
                  
                  </p>
              </div>
              <p class="text-center">Arrive at Corbett, Check-in at the hotel. After breakfast, go for sightseeing like;  Garjiya Devi <br>
                Temple or Corbett museum or you can go for a safari after lunch.   
                Later in the evening, you can spend time at the hotel.<br> Overnight stay at the hotel Ramnagar.   
              </p>
              <div class="col-12 col-xxl-7 fw-bold fs-2 text-info text-center">
                <p> Day 2 ./ <br>
                  Corbett Jungle Safari - Departure  <br>
                  
                  </p>
              </div>
              <p class="text-center">Get up early in the morning and go for a jeep safari at Corbett National Park, <br>  
                After safari back to the hotel have, drive back to Delhi. On arrival in Delhi, we will transfer <br>
                you to Delhi Airport/Railway Station. 
                <br>Our services will end there and you can go back to your places with some of the best 
                  ...
                  <div class="carousel-inner">
                    ...
                    <div class="carousel-item" data-bs-interval="2000">
                      <div class="row h-100">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="kumaon_8_nights.php"><img class="img-fluid" src="assets/img/gallery/beaches.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="khirsu_4_nights.php"><img class="img-fluid" src="assets/img/gallery/wild.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
