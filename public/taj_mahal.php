...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <meta property="og:image" content="https://deveshtourtravels.com/assets/img/gallery/taj3.jpg"/>
    <meta property="og:image:width" content="550"/><meta property="og:image:height" content="370"/>
    <meta property="twitter:image" content="https://deveshtourtravels.com/assets/img/gallery/taj3.jpg"/>
    <!-- ===============================================-->
    <!--    Favicons-->
    <!-- ===============================================-->
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="py-0">
        <div class="bg-holder d-none d-md-block" style="background-image:url(assets/img/gallery/taj9.jpg);background-position:right bottom;background-size:contain;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container">
          <div class="row flex-md-center">
            <div class="col-md-11 col-lg-4 py-md-3 px-4 px-md-3 px-lg-0 px-xl-2 order-lg-1">
              <h1 class="fw-bold fs-md-3 fs-xl-5">Points of Attraction</h1>
              <hr class="text-primary my-4 my-lg-3 my-xl-4" style="height:3px; width:70px;" />
              <p class="lh-lg">
                Agra Fort is located on the banks of the Yamuna River in the city of Agra. The Red Fort is listed in the UNESCO World Heritage Site. Agra Fort is one of the famous buildings of the Mughal period which was built by Emperor Akbar. Akbar was one of the Mughal rulers in about 1565 AD. The Agra Fort wall was made of sandstone and the fort had only four gates. The most famous places in the fort are Khas Mahal, Sheesh Mahal, Mosque. Visit Agra and do shopping at Meena Bazaar and other places.
                </p><a class="btn btn-lg btn-primary hover-top" href="#" role="button">Explore</a>
            </div>
              ...
              <div class="carousel slide" id="carouselExampleControlsNoTouching" data-bs-touch="false" data-bs-interval="false">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <div class="row h-100">
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="assets/img/gallery/aksharadham.jpg" alt="" />
                      ...
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="assets/img/gallery/fort5.jpeg" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                            <div class="pt-3"></div>
                            <div class="ps-3 d-flex justify-content-between align-items-center">
                            </div>
                      ...
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="assets/img/gallery/fort.jpeg" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                            <div class="pt-3"></div>
                            <div class="ps-3 d-flex justify-content-between align-items-center">
                            </div>
                  ...
                  <div class="carousel-item">
                    <div class="row h-100">
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="assets/img/gallery/fort2.jpg" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                            <div class="pt-3"></div>
                            <div class="ps-3 d-flex justify-content-between align-items-center">
                            </div>
        ...
        <div class="container">
          <div class="row flex-center mb-5">
            <div class="col-lg-8 text-center">
              <h1 class="fw-bold fs-md-3 fs-lg-4 fs-xl-5">DAY TRIP TAJ MAHAL AGRA</h1>
              <hr class="mx-auto text-primary my-4" style="height:3px; width:70px;" />
              <p class="mx-auto">Delhi Agra Same Day Tour (Taj Mahal Tour)</p>
            </div>
          </div>
                  <div class="col-12 col-xxl-7 px-5 text-dark">
                    <ul>
                    <li>Taj Mahal one day tour.</li>
                    <li>All Inclusive - No Hidden Fees.</li>
                    <li>Easy online booking and fair pricing.</li>
                    <li>Verified Fleet & Trained Drivers.</li>
                    <li> Timely Pickup - Anywhere in Delhi.</li>
                    <li>  Price per car, not per person.</li>
                    <li>Same Day Taj Mahal Tour By Car.</li>
                    <li>230 kms, approx. 3 & 1/2 hours’ drive from Delhi-NCR.</li>
                  </ul>
          
                  </div>
                  <div class="col-12 col-xxl-7 py-4 text-info">
                    <ul>
                    <li> Includes: AC Car, Driver Allowance, All Toll Taxes, State Taxes, Parking Charges and Excellent Service.</li>
                    <li>Excludes: Any monument entry ticket, any meal, guide fee (if any) are not included in this package</li>
                    <li>Booking form</li>
                ...
                <div class="carousel slide" id="carouselCategory" data-bs-touch="false" data-bs-interval="false">
                  <div class="carousel-inner">
                    ...
                    <div class="carousel-item" data-bs-interval="2000">
                      <div class="row h-100">
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="kumaon_8_nights.php"><img class="img-fluid" src="assets/img/gallery/food.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="haridwar_2_nights.php"><img class="img-fluid" src="assets/img/gallery/backpacking.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="khirsu_4_nights.php"><img class="img-fluid" src="assets/img/gallery/art-culture.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="mussoorie_3_nights.php"><img class="img-fluid" src="assets/img/gallery/wild.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                    ...
                    <div class="carousel-item">
                      <div class="row h-100 offset-lg-2">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="chamba_3_nights.php"><img class="img-fluid" src="assets/img/gallery/beaches.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                              <h5 class="text-white fs--1">Beaches,coast and island</h5>
                            </div>
                          </div>
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="kumaon_8_nights.php"><img class="img-fluid" src="assets/img/gallery/art-culture.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                              <h5 class="text-white fs--1">Art and culture</h5>
                            </div>
                          </div>
