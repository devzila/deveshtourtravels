...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Devesh Tour Travels: Nainital Mukteshwar with Corbett  Tour Package &amp; We provide bus and taxi services for Nainital Mukteshwar with Corbett  Tour Package.</title>
    ...
    <meta property="og:title" content="Devesh Tour Travels: Nainital Mukteshwar with Corbett  Tour Package &amp; We provide bus and taxi services for Nainital Mukteshwar with Corbett  Tour Package"/>
    ...
    <meta property="og:image" content="https://deveshtourtravels.com/assets/img/gallery/nainital2.jpg"/>
    <meta property="og:image:width" content="550"/><meta property="og:image:height" content="370"/>
    <meta property="twitter:image" content="https://deveshtourtravels.com/assets/img/gallery/nainital2.jpg"/>
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="py-0">
        <div class="bg-holder d-none d-md-block" style="background-image:url(assets/img/gallery/nainital2.jpg);background-position:right bottom;background-size:contain;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container position-relative">
          <div class="row align-items-center min-vh-75 my-lg-8">
            <div  class="col-md-4 text-center text-md-start py-3">
              <h2 class="mb-4 display">	Nainital Mukteshwar with Corbett  Tour Package  Duration 5 Nights / 6 Days :-</h2>
              <p>
                Only 318 Kms 6hrs north of Delhi by road, Nainital is a good weekend destination. Far from 
                the madding crowds in such proximity, one could enjoy its natural beauty. Nainital - 
                Mukteshwar hills boosts of its great diversity that makes it a wonderful destination.  
                
                While on the other hand; the oldest national park in the country, Jim Corbett National Park 
                brings in thousands of wildlife enthusiasts each year. 
        ...
        <div class="container">
          <div class="row flex-center mb-5">
            <div class="col-lg-8 text-center">
              <h1 class="fw-bold fs-md-3 fs-lg-4 fs-xl-5"> Book a Taxi now for your Nainital Mukteshwar with Corbett  Tour Package </h1>
              <hr class="mx-auto text-primary my-4" style="height:3px; width:70px;" />
              <p class="mx-auto">Explore our Nainital - Mukteshwar - Jim Corbett Tour Package for complete details.   
                </p>
              ...
              <p class="text-center">Check in to the hotel. Enjoy the day at any of the scenic locations of place and relax yourself 
              ...
              <p class="text-center">Visit the Cheena Peak which offers a breathtaking view of the Himalayas.<br>  
                Spend rest of the day with a trip to Bhim Tal, Sat Tal, and Naukuchia Tal.     </p>
                  ...
                  <p class="text-center">After breakfast head to Mukteshwar for a full day outing. <br> 
                    Set in the Kumaon hills, Mukteshwar is a popular tourist destination, visit Mukteshwar 
                    Temple,<br> enjoy a cable car ride to the snow viewpoint. <br>  
                    Enjoy the evening and stay in Mukteshwar hotel.  </p>
                    <div class="col-12 col-xxl-7 fw-bold fs-2 text-info text-center">
                      <p> Day 3 ./ <br>
                        Nainital - Mukteshwar 
                        </p>
                    ...
                    <p class="text-center">After breakfast head to Mukteshwar for a full day outing. <br> 
                      ...
                      <p class="text-center">After having breakfast, You can visit Ramgarh and the drive to Corbett National Park.<br> 
                        Check-in at the resort, evening at leisure to explore the resort and its in house activities.<br> 
                        Overnight stay at Corbett.   </p>
                        <div class="col-12 col-xxl-7 fw-bold fs-2 text-info text-center">
                          <p> Day 5 ./ <br>
                        ...
                        <p class="text-center">Corbett National Park is famous for its wildlife population of Tigers, Leopards and Elephants. <br>
                          Go on early morning safari/ jeep safari into the forest. <br> 
                          After lunch proceeds for an afternoon jeep safari inside the Corbett national park. <br> 
                          Overnight stay at the hotel in Corbett. </p>
                          <div class="col-12 col-xxl-7 fw-bold fs-2 text-info text-center">
                            <p> Day 6 ./ <br>
                              Departure from Corbett  
                              </p>
                          </div>
                          <p class="text-center">After an early breakfast, drive back to Delhi. On arrival in Delhi, we will transfer you to Delhi 
                            Airport/Railway Station. <br>
                ...
                <div class="carousel slide" id="carouselCategory" data-bs-touch="false" data-bs-interval="false">
                  <div class="carousel-inner">
                    ...
                    <div class="carousel-item" data-bs-interval="2000">
                      <div class="row h-100">
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="chamba_3_nights.php"><img class="img-fluid" src="assets/img/gallery/food.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="mussoorie_3_nights.php"><img class="img-fluid" src="assets/img/gallery/backpacking.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="rishikesh.php"><img class="img-fluid" src="assets/img/gallery/art-culture.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="rajasthan_tour.php"><img class="img-fluid" src="assets/img/gallery/wild.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="nainital_almora_7_nights.php"><img class="img-fluid" src="assets/img/gallery/hill.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                              <h5 class="text-white fs--1">Hill and nature</h5>
                            </div>
                          </div>
