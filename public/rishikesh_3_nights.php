...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Devesh Travels: Haridwar - Rishikesh 3 Nights Tour Package  &amp; We provide bus and taxi services for  Haridwar - Rishikesh 3 Nights Tour Package .</title>
    ...
    <meta property="og:title" content="Devesh Travels:  Haridwar - Rishikesh 3 Nights Tour Package  &amp; We provide bus and taxi services for  Haridwar - Rishikesh 3 Nights Tour Package ."/>
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="py-0">
        <div class="bg-holder d-none d-md-block" style="background-image:url(assets/img/gallery/rishikesh.jpg);background-position:right bottom;background-size:contain;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container position-relative">
          <div class="row align-items-center min-vh-75 my-lg-8">
            <div  class="col-md-4 text-center text-md-start py-3">
              <h2 class="mb-4 display">	Haridwar - Rishikesh 3 Nights Tour Package :-</h2>
              <p class="text-danger fs-2" >Price on Request </p>
              <p>
              This tour package allows you to visit some of the most spiritual and fascinating 
              places in the holy cities of Haridwar and Rishikesh. Visit Haridwar, which is regarded 
              as one of the seven holiest places for Hindus.<br>Excursion to Rishikesh strategically located on the banks of river Ganga, which is the 
              town of saints, sages & scholars. Now a day’s Rishikesh is also famous for <b> yoga 
              teachings Rishikesh.</b>  
              ...
              <p>Visual Bliss and tranquil environment: these words perfectly describe Rishikesh and 
                Haridwar.  </p>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row flex-center mb-5">
            <div class="col-lg-8 text-center">
              <h1 class="fw-bold fs-md-3 fs-lg-4 fs-xl-5"> Book a Taxi now for your Haridwar - Rishikesh 3 Nights </h1>
              <hr class="mx-auto text-primary my-4" style="height:3px; width:70px;" />
              <p class="mx-auto">Being two of the <b>major tourist attractions</b> in the state, these coming together in a 
                travel package will be a delectable delicacy for the eyes and minds of travelers!  
                </p>
                <p>Also considered as the twin national heritage cities of India, Haridwar and Rishikesh 
                  are the perfect weekend gateways from Delhi. </p>
            </div>
          </div>
              <div class="col-12 col-xxl-7 fw-bold fs-2 text-info text-center">
                <p> 
                  Tour Itinerary./ <br>
                  Day 1 ,<br>
                  Arrival in Rishikesh ./<br> 
                  StayHotel ./
                  </p>
              </div>
              <p class="text-center">Check-in at the hotel, spend the day at leisure. Later, return to your hotel for a comfortable stay at the hotel in <b> Rishikesh. </b> </p>
              <div class="col-12 col-xxl-7 fw-bold fs-2 text-info text-center">
                <p> Day 2 ./ <br>
                  Rishikesh Sightseeing  <br>
                  StayHotel ./
                  </p>
              </div>
              <p class="text-center">Spend the day at leisure. You can visit Jump in Heights,<br> an amusement park famous 
                for its bungee jump, canyon swing and Asia's longest flying fox.<br>  
                You can end your day with a visit to one of the several cafes. Later, return to your 
                hotel for a comfortable stay in <b> Rishikesh.</b>   
              </p>
              
                  <div class="col-12 col-xxl-7 fw-bold fs-2 text-info text-center">
                    <p> Day 3 ./ <br>
                      Rishikehs to Haridwar./ <br>
                      StayHotel .
                    </p>
                  </div>
                  <p class="text-center">On this day, check-out from your hotel, and make your way to <b>Haridwar.</b>  <br>Once there, 
                    check-in to your hotel and spend the day at leisure. <br> 
                    Later, return to your hotel for a comfortable stay at hotel in <b>Haridwar.</b>  </p>
                    <div class="col-12 col-xxl-7 fw-bold fs-2 text-info text-center">
                      <p> Day 3 ./ <br>
                      </p>
                    </div>
                    <p class="text-center">Check out of your Haridwar hotel in the morning. </p>
                  ...
                  <div class="carousel-inner">
                    ...
                    <div class="carousel-item" data-bs-interval="2000">
                      <div class="row h-100">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="gumkhal_2_nights.php"><img class="img-fluid" src="assets/img/gallery/art-culture.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="haridwar_2_nights.php"><img class="img-fluid" src="assets/img/gallery/wild.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
