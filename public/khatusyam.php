...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <meta property="og:image" content="https://deveshtourtravels.com/assets/img/gallery/raj.jpeg"/>
    <meta property="og:image:width" content="550"/><meta property="og:image:height" content="370"/>
    <meta property="twitter:image" content="https://deveshtourtravels.com/assets/img/gallery/raj.jpeg"/>
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="py-0">
        <div class="bg-holder d-none d-md-block" style="background-image:url(assets/img/gallery/raj.jpeg);background-position:right bottom;background-size:contain;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container">
          <div class="row flex-md-center">
            <div class="col-md-11 col-lg-4 py-md-3 px-4 px-md-3 px-lg-0 px-xl-2 order-lg-1">
              <h1 class="fw-bold fs-md-3 fs-xl-5">Amazing Char Dham Yatra Places </h1>
              <hr class="text-primary my-4 my-lg-3 my-xl-4" style="height:3px; width:70px;" />
              <p class="lh-lg"> Chardham Yatra in Uttarakhand, India is one of the most desired pilgrimages in Hinduism.
                 All devotees, especially Shiva devotees, Vishnu devotees, aspire to visit this holy Char Dham once in a lifetime.
                 Many pilgrims come to Badrinath Dham to pay obeisance to their ancestors.</p><a class="btn btn-lg btn-primary hover-top" href="#" role="button">Explore</a>
            </div>
            <div>
              <p class="lh-lg">Here travel by car from Delhi will take you to the holy shrines with the most comfortable experience.</p>
            </div>
                ...
                <div class="carousel slide" id="carouselCategory" data-bs-touch="false" data-bs-interval="false">
                  <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="10000">
                      <div class="row h-100">
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="local_taxi.php"><img class="img-fluid" src="assets/img/gallery/image1.jpeg" alt="" /></a>
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="outstation_rates.php"><img class="img-fluid" src="assets/img/gallery/images2.jpeg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="conference_tour.php"><img class="img-fluid" src="assets/img/gallery/images3.jpeg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="mathura.php"><img class="img-fluid" src="assets/img/gallery/images4.png" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="local_taxi.php"><img class="img-fluid" src="assets/img/gallery/images6.png" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                    ...
                    <div class="carousel-item" data-bs-interval="2000">
                      <div class="row h-100">
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="amritsar.php"><img class="img-fluid" src="assets/img/gallery/food.png" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="nainital_almora_7_nights.php"><img class="img-fluid" src="assets/img/gallery/backpacking.png" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="rajasthan_tour.php"><img class="img-fluid" src="assets/img/gallery/art-culture.png" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="bhimtal_nainital_4_nights.php"><img class="img-fluid" src="assets/img/gallery/wild.png" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
