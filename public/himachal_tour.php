...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <meta property="twitter:image" content="https://deveshtravels.com/assets/img/gallery/hill.jpg"/>
                ...
                <div class="carousel slide" id="carouselCategory" data-bs-touch="false" data-bs-interval="false">
                  <div class="carousel-inner">
                    ...
                    <div class="carousel-item" data-bs-interval="2000">
                      <div class="row h-100">
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="chamba_3_nights.php"><img class="img-fluid" src="assets/img/gallery/food.jpeg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="khirsu_4_nights.php"><img class="img-fluid" src="assets/img/gallery/backpacking.png" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="khirsu_4_nights.php"><img class="img-fluid" src="assets/img/gallery/beaches.png" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="madhaya_pradesh.php"><img class="img-fluid" src="assets/img/gallery/art-culture.png" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="amarnath_yatra.php"><img class="img-fluid" src="assets/img/gallery/wild.png" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
