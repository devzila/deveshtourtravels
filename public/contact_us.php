          ...
          <div class="row align-items-center min-vh-75 my-lg-8">
            <div class="col-md-7 col-lg-6 text-center text-md-start py-8">
              ...
              <div class="col-md-7 col-lg-6 text-center text-md-start text-dark">
                ...
                <p class="mx-auto text-info px-7">24x7</p><a class="btn btn-lg btn-primary hover-top" href="#" role="button">+91 7021159617</a><a class="btn btn-lg btn-primary hover-top" href="#" role="button">+91 9711113179</a>
              </div>
            </div>
          </div>
        </div>
