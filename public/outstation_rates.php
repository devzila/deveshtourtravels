...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <meta property="og:image" content="https://deveshtravels.com/assets/img/gallery/images3.jpg"/>
    <meta property="og:image:width" content="550"/><meta property="og:image:height" content="370"/>
    <meta property="twitter:image" content="https://deveshtravels.com/assets/img/gallery/images3.jpg"/>
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="py-0">
        <div class="bg-holder d-none d-md-block" style="background-image:url(assets/img/gallery/images3.jpg);background-position:right bottom;background-size:contain;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container position-relative">
          <div class="row align-items-center min-vh-75 my-lg-8">
            <div class="col-md-4 text-center text-md-start py-3">
              ...
              <p class="text-info">Cheap Taxi Rates in Delhi with Devesh and Travels</p>
              <p class="text-info">
            ...
            <div class="col-md-9">
              <p>Devesh & Travels is a Delhi based reliable and efficient cab service for outstation and local use, that offers a range of vehicles to suit the requirements of its clients. Here, you can find the current taxi fare in Delhi NCR from Devesh & Travels, we will also try to compare with the fares of other taxi companies in the city</p>
            </div>
        ...
        <div class="container">
          <div class="row flex-center mb-5">
            <div class="col-lg-8 text-center">
              <h1 class="fw-bold fs-md-3 fs-lg-4 fs-xl-5">Taxi rates in Delhi to Outstation Travel</h1>
              <hr class="mx-auto text-primary my-4" style="height:3px; width:70px;" />
              <p class="mx-auto">Outstation Cab Fare in Delhi (as on July 2023)</p>
            </div>
          </div>
                        ...
                        <table class="table">
                          <thead>
                            <tr>
                              ...
                              <th scope="col">Per Day Limit</th>
                              <th scope="col">Driver Allowance Per Day</th>
                          ...
                          <tbody>
                            <tr>
                              <td>Dizer or Equivalent</td>
                              <td class="px-4">4 + 1 </td>
                              <td>Rs. 15 per km </td>
                              <td class="px-5">250km </td>
                              <td class="px-7">500</td>
                              <td><a href="form.html" class="btn btn-primary btn active" role="button" aria-pressed="true">Book Now</a></td>
                            </tr>
                            <tr>
                              <td>Ertiga</td>
                              <td class="px-4"> 6 + 1 </td>
                              <td>Rs. 18 per km</td>
                              <td class="px-5">250km</td>
                              <td class="px-7">500</td>
                              <td><a href="form.html" class="btn btn-primary btn active" role="button" aria-pressed="true">Book Now</a></td>
                            ...
                            <tr>
                              ...
                              <td>Rs. 35 per km</td>
                              <td class="px-5"> 250km</td>
                              <td class="px-7">800</td>
                              <td><a href="form.html" class="btn btn-primary btn active" role="button" aria-pressed="true">Book Now</a></td>
                            </tr>
                            <tr>
                              <td>Tempo Traveller 12-Seater  </td>
                              <td class="px-4">11 + 1</td>
                              <td>Rs. 30 per km</td>
                              <td class="px-5">250km</td>
                              <td class="px-7">700</td>
                              <td><a href="form.html" class="btn btn-primary btn active" role="button" aria-pressed="true">Book Now</a></td>
                            </tr>
                            <tr>
                              <td>Tempo Traveller 16-Seater  </td>
      ...
      <section class="pt-5" id="featuresVideos">
        ...
        <div class="container">
          <div class="row flex-center mb-5">
            <div class="col-lg-8 text-center">
              <h1 class="fw-bold fs-md-3 fs-lg-4 fs-xl-5">Our Delhi/NCR Local Charges</h1>
              <hr class="mx-auto text-primary my-4" style="height:3px; width:70px;" />
            </div>
          </div>
          <div class="row flex-center">
            <div class="col-12">
              <div class="carousel slide" id="carouselExampleIndicators" data-bs-touch="false" data-bs-interval="false">
                <div class="row align-items-center">
                      ...
                      <div class="carousel-item active h-100">
                        <table class="table">
                          <thead>
                            <tr>
                              <th scope="col">Cab Type </th>
                              <th scope="col">8hrs/ 80km Local Charges </th>
                              <th scope="col">Driver Allowance Per Day</th>
                              <th scope="col">Booking</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr>
                              <td>Dizer or Equivalent</td>
                              <td class="px-5">Rs.1800  extra km 18 extra hrs 200</td>
                              <td class="px-7" >200</td>
                              <td><a href="form.html" class="btn btn-primary btn active" role="button" aria-pressed="true">Book Now</a></td>
                            </tr>
                            <tr>
                              <td>Ertiga</td>
                              <td class="px-5">Rs.2400 extra km 22 extra hrs 200</td>
                              <td class="px-7">200</td>
                              <td><a href="form.html" class="btn btn-primary btn active" role="button" aria-pressed="true">Book Now</a></td>
                            </tr>
                            <tr>
                              <td>Innova </td>
                              <td class="px-5">Rs.2600 extra km 26 extra hrs 200 </td>                              
                              <td class="px-7"> 300</td>
                              <td><a href="form.html" class="btn btn-primary btn active" role="button" aria-pressed="true">Book Now</a></td>
                            </tr>
                            <tr>
                              <td>Innova Crysta</td>
                              <td class="px-5">Rs.3000  extra km 30 extra hrs 200  </td>
                              <td class="px-7">300</td>
                              <td><a href="form.html" class="btn btn-primary btn active" role="button" aria-pressed="true">Book Now</a></td>
                            </tr>
                            <tr>
                              <td>Fortuner</td>
                              <td class="px-5">   Rs.5000 extra km 45 extra hrs 600 </td>
                              <td class="px-7">500</td>
                              <td><a href="form.html" class="btn btn-primary btn active" role="button" aria-pressed="true">Book Now</a></td>
                            </tr>
                            <tr>
                              <td>Tempo Traveller 12-Seater 11 + 1   </td>
                              <td class="px-5">Rs.6000  extra km 30 extra hrs 600  </td>
                              <td class="px-7">500</td>
                              <td><a href="form.html" class="btn btn-primary btn active" role="button" aria-pressed="true">Book Now</a></td>
                            </tr>
                            <tr>
                              <td>Tempo Traveller 16-Seater 16 + 1   </td>
                              <td class="px-5">Rs.6000  extra km 32 extra hrs 600  </td>
                              <td class="px-7">500</td>
                              <td><a href="form.html" class="btn btn-primary btn active" role="button" aria-pressed="true">Book Now</a></td>
                            </tr>
                          </tbody>
                  ...
                  <div py-5>
                    <p class="text-info">Parking extra as per actual  slip ./-</p>
                  </div>
                  <div>
                    <p class="text-dark">Devesh and Travels offers competitive rates for its taxi services in Delhi. The base fare for a taxi ride is ₹25, with a charge of ₹13 per kilometre and ₹1 per minute of travel. There may be additional charges for certain services, such as airport pick-ups or drop-offs, which carry a surcharge of ₹150. Tolls and other fees may also apply. Devesh and Travels occasionally offers promotions and discounts for its customers, so be sure to check our website or Call us  for the latest deals.</p><a class="btn btn-lg btn-primary hover-top" href="#" role="button">+91-7021159617</a>
                  </div>
                  <div class="py-5 text-md-start">
                    <h3>Comparison with other taxi companies:-</h3>
                    <p>Our Outstation Cab Fare as well as local taxi rates are competitive with other taxi companies in Delhi. When compared to other providers, Devesh and Travels offers excellent value for money with its reasonable base fares and per kilometre charges.</p>
                    <p>In conclusion, Devesh and Travels offers affordable and reliable taxi services in Delhi, with competitive rates that are on par with other companies in the Delhi & NCR. Whether you need a ride to the airport, a trip across town, or want to hire a Cab for Outstation with Driver, Devesh and Travels has you covered. For more information or to book a taxi, visit Devesh and Travels or Contact us </p><a class="btn btn-lg btn-primary hover-top" href="#" role="button">+91-7021159617</a>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="10000">
                      <div class="row h-100">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="ad_film_shooting.php"><img class="img-fluid" src="assets/img/gallery/images4.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="jammu_tour.php"><img class="img-fluid" src="assets/img/gallery/hill.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                    ...
                    <div class="carousel-item" data-bs-interval="2000">
                      <div class="row h-100">
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="amritsar.php"><img class="img-fluid" src="assets/img/gallery/food.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="mathura.php"><img class="img-fluid" src="assets/img/gallery/backpacking.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="mussoorie_3_nights.php"><img class="img-fluid" src="assets/img/gallery/beaches.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="taj_mahal.php"><img class="img-fluid" src="assets/img/gallery/art-culture.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="rishikesh.php"><img class="img-fluid" src="assets/img/gallery/wild.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="haridwar_2_nights.php"><img class="img-fluid" src="assets/img/gallery/hill.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                              <h5 class="text-white fs--1">Hill and nature</h5>
                            </div>
                          </div>
                    ...
                    <div class="carousel-item">
                      <div class="row h-100 offset-lg-2">
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="himachal_tour.php"><img class="img-fluid" src="assets/img/gallery/food.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                              <h5 class="text-white fs--1">Food</h5>
                            </div>
                          </div>
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="nainital_mukteshwar_5_nights.php"><img class="img-fluid" src="assets/img/gallery/backpacking.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                              <h5 class="text-white fs--1">Backpacking</h5>
                            </div>
                          </div>
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="nainital_mukteshwar_5_nights.php"><img class="img-fluid" src="assets/img/gallery/beaches.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                              <h5 class="text-white fs--1">Beaches,coast and island</h5>
                            </div>
                          </div>
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="ladakh_tour.php"><img class="img-fluid" src="assets/img/gallery/art-culture.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                              <h5 class="text-white fs--1">Art and culture</h5>
                            </div>
                          </div>
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="jim_corbett_1_nights.php"><img class="img-fluid" src="assets/img/gallery/wild.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                              <h5 class="text-white fs--1">Wildlife and nature</h5>
                            </div>
                          </div>
