...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Devesh Travels: 2 NIGHT/3 DAYS KHIRSU TRIP  &amp; We provide bus and taxi services for 2 NIGHT/3 DAYS KHIRSU TRIP </title>
    ...
    <meta property="og:title" content="Devesh Travels: 2 NIGHT/3 DAYS KHIRSU TRIP  &amp; We provide bus and taxi services for 2 NIGHT/3 DAYS KHIRSU TRIP "/>
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="py-0">
        <div class="bg-holder d-none d-md-block" style="background-image:url(assets/img/gallery/khirsu.jpg);background-position:right bottom;background-size:contain;">
        </div>
        <!--/.bg-holder-->
                  ...
                  <div class="carousel-inner">
                    ...
                    <div class="carousel-item" data-bs-interval="2000">
                      <div class="row h-100">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="nainital_almora_7_nights.php"><img class="img-fluid" src="assets/img/gallery/art-culture.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="khirsu_2_nights.php"><img class="img-fluid" src="assets/img/gallery/wild.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
