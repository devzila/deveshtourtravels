...
<html lang="en-US" dir="ltr">
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="py-0">
        <div class="bg-holder d-none d-md-block" style="background-image:url(assets/img/gallery/hill.jpeg);background-position:right bottom;background-size:contain;">
        </div>
        <!--/.bg-holder-->
