...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Devesh Tour Travels: Uttar Pradesh Bus & Taxi PACKAGES &amp; We provide bus and taxi services for Uttar Pradesh.</title>
    ...
    <meta property="og:image" content="https://deveshtourtravels.com/assets/img/gallery/fort3.jpg"/>
    <meta property="og:image:width" content="550"/><meta property="og:image:height" content="370"/>
    <meta property="twitter:image" content="https://deveshtourtravels.com/assets/img/gallery/fort3.jpg"/>
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="py-0">
        <div class="bg-holder d-none d-md-block" style="background-image:url(assets/img/gallery/fort3.jpg);background-position:right bottom;background-size:contain;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container position-relative">
          <div class="row align-items-center min-vh-75 my-lg-8">
            <div  class="col-md-4 text-center text-md-start py-3">
              <h2 class="mb-4 display">		Uttar Pradesh: Bus & Taxi PACKAGES</h2>
              <p>
              Uncover the rich cultural and historical heritage of Uttar Pradesh with our tour packages. Visit iconic sites like the Taj Mahal in Agra and the spiritual centers of Varanasi.
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="10000">
                      <div class="row h-100">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="char_dham.php"><img class="img-fluid" src="assets/img/gallery/hill.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                    ...
                    <div class="carousel-item" data-bs-interval="2000">
                      <div class="row h-100">
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="gumkhal_2_nights.php"><img class="img-fluid" src="assets/img/gallery/food.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
