...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Devesh Tour Travels: 4night/5 days khirsu, chopta trip  &amp; We provide bus and taxi services for 4night/5 days khirsu, chopta trip .</title>
    ...
    <meta property="og:title" content="Devesh Tour Travels: 4night/5 days khirsu, chopta trip  &amp; We provide bus and taxi services for 4night/5 days khirsu, chopta trip ."/>
    ...
    <meta property="og:image" content="https://deveshtourtravels.com/assets/img/gallery/khirsu.jpg"/>
    <meta property="og:image:width" content="550"/><meta property="og:image:height" content="370"/>
    <meta property="twitter:image" content="https://deveshtourtravels.com/assets/img/gallery/khirsu.jpg"/>
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="py-0">
        <div class="bg-holder d-none d-md-block" style="background-image:url(assets/img/gallery/khirsu2.jpg);background-position:right bottom;background-size:contain;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container position-relative">
          <div class="row align-items-center min-vh-75 my-lg-8">
            <div  class="col-md-4 text-center text-md-start py-3">
              <h2 class="mb-4 display">	4 Night/ 5 Days Khirsu, Chopta Trip :-</h2>
              <p>
                ...
                background. Khirsu village offers the 300 km wide panoramic view of some popular 
        ...
        <div class="container">
          <div class="row flex-center mb-5">
            <div class="col-lg-8 text-center">
              <h1 class="fw-bold fs-md-3 fs-lg-4 fs-xl-5"> Book a Taxi now for your 4 Night/ 5 Days Khirsu, Chopta Trip  </h1>
              <hr class="mx-auto text-primary my-4" style="height:3px; width:70px;" />
              <p class="mx-auto">Chopta is a popular destination in Uttarakhand state. Many adventure lovers visit Chopta 
                every year. Chopta is a base of many popular trekking routes like- Tungnath Trek, 
                Chandrashila trek. Chopta is a small meadow which is situated at an elevation of 2680 m 
                and is also a part of Kedarnath Wildlife Sanctuary in Uttarakhand state. Chopta is an 
                unspoiled natural destination nestled in the foothills of Himalayas. Chopta is a perfect 
                destination for adventure lovers and trekkers in Uttarakhand. 
                </p>
            </div>
          </div>
              ...
              <p class="text-center">Arrival at Khirsu, check-in to the hotel and take some rest there. <br>You can explore some 
              ...
              <p class="text-center">After breakfast, be ready for the sightseeing of this beautiful place, we take you to some of <br>
                the famous places in Khirsu. After the sightseeing of Khirsu and Pauri, way back to the hotel. <br>
                Overnight stay and dinner at the hotel in Khirsu.     </p>
                  ...
                  <p class="text-center">Alt2680 m After breakfast, travel to Chopta from Khirsu. After arrival at Chopta,<br> check-in to 
                    the hotel and take some rest there. Explore the beautiful place <br>for the remaining day. Dinner 
                    and overnight stay at the hotel in Chopta.<br> The driving distance or the travel distance between khirsu to chopta is 72km 3hrs .  </p>
                    <div class="col-12 col-xxl-7 fw-bold fs-2 text-info text-center">
                      <p> Day 4 ./ <br>
                        Chopta - Tungnath trek ./<br>
                        Alt2680 m 
                        </p>
                    </div>
                    <p class="text-center">After breakfast, start trekking for a popular and an easy trek of Tungnath temple. After arrival<br> 
                      at Tungnath temple seek some blessing with your loved ones from God. Have your packed 
                      lunch and <br>then trek down to the Chopta, Dinner and overnight stay at the hotel in Chopta. 
                    ...
                    <p class="text-center">After an early breakfast, drive back to Delhi. On arrival in Delhi, we will transfer you to Delhi 
                      Airport/Railway Station. <br>Our services will end there and you can go back to your places with some of the best 
                ...
                <div class="carousel slide" id="carouselCategory" data-bs-touch="false" data-bs-interval="false">
                  <div class="carousel-inner">
                    ...
                    <div class="carousel-item" data-bs-interval="2000">
                      <div class="row h-100">
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="mathura.php"><img class="img-fluid" src="assets/img/gallery/food.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="utarakhand_tour.php"><img class="img-fluid" src="assets/img/gallery/backpacking.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="himachal_tour.php"><img class="img-fluid" src="assets/img/gallery/beaches.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="rishikesh_3_nights.php"><img class="img-fluid" src="assets/img/gallery/art-culture.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="jammu_tour.php"><img class="img-fluid" src="assets/img/gallery/wild.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="rajasthan_tour.php"><img class="img-fluid" src="assets/img/gallery/hill.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                              <h5 class="text-white fs--1">Hill and nature</h5>
                            </div>
                          </div>
