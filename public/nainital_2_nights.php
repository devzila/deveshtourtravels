        ...
        <div class="container position-relative">
          <div class="row align-items-center min-vh-75 my-lg-8">
            <div  class="col-md-4 text-center text-md-start py-3">
              <h2 class="mb-4 display">	Nainital Tour Package Package Duration 3 Days / 2 Nights  :-</h2>
              <p>
                Nainital Kumaoni: Naintāl; pronounced  is a town and headquarters of Nainital district of 
                    Kumaon division, Uttarakhand, India. It is the judicial capital of Uttarakhand, the High Court 
                    of the state being located there and is the headquarters of an eponymous district. It also 
                    houses the Governor of Uttarakhand,[7] who resides in the Raj Bhavan. Nainital was the 
                    summer capital[8] of the United Provinces.   
        ...
        <div class="container">
          <div class="row flex-center mb-5">
            <div class="col-lg-8 text-center">
              <h1 class="fw-bold fs-md-3 fs-lg-4 fs-xl-5"> Book a Taxi now for your Nainital Tour Package  Duration 3 Days / 2 Nights </h1>
              <hr class="mx-auto text-primary my-4" style="height:3px; width:70px;" />
              <p class="mx-auto">Nainital is located in the Kumaon foothills of the outer Himalayas at a distance of 285 km 
                (177 mi) from the state capital Dehradun and 345 km (214 mi) from New Delhi, the capital of 
                India. Situated at an altitude of 1,938 metres (6,358 ft) above sea level, the town is set in a 
                valley containing an eye-shaped lake, approximately two miles in circumference, and 
                surrounded by mountains, of which the highest are Naina Peak (2,615 m (8,579 ft)) on the 
                north, Deopatha (2,438 m (7,999 ft)) on the west, and Ayarpatha (2,278 m (7,474 ft)) on the 
                south. From the tops of the higher peaks, "magnificent views can be obtained of the vast 
                plain to the south, or of the mass of tangled ridges lying north, bound by the great snowy 
                range which forms the central axis of the Himalayas."[9] The hill station attracts tourists round the year. 
                </p>
            </div>
          </div>
              <div class="col-12 col-xxl-7 fw-bold fs-2 text-info text-center">
                <p> 
                  Tour Itinerary./ <br>
                  Day 1 ,<br>
                  Arrive in Nainital ./<br> 
                  StayHotel ./
                  </p>
              </div>
              <p class="text-center">In the morning, arrive in Nainital and check-in at the hotel. <br>In the evening you can visit Naini 
                 Lake, Naina Devi Temple. Overnight stay.    
              </p>
              <div class="col-12 col-xxl-7 fw-bold fs-2 text-info text-center">
                <p> Day 2 ./ <br>
              ...
              <p class="text-center">After Breakfast goes for the Nainital Lake Tour, which includes; Bhimtal, Sattal, and <br>
                 Naukuchiyatal. In the evening you can visit mall road Overnight stay at the hotel in Nainital    </p>
                
                  <div class="col-12 col-xxl-7 fw-bold fs-2 text-info text-center">
                    <p> Day 3 ./ <br>
                      </p>
                  </div>
                  <p class="text-center">After Breakfast goes for the Tiffin Top, Zoo, or enjoy shopping at Mall Road. Overnight stay 
                    at the hotel in Nainital.  </p>
                    <div class="col-12 col-xxl-7 fw-bold fs-2 text-info text-center">
                    <p> Day 4 ./ <br>
                      Departure. 
                      </p>
                  </div>
                  <p class="text-center">Check out of your hotel in the morning.   </p>
                  <p class="text-center">Departure from Nanita.   </p>
                  <p class="text-center">After breakfast, departure from hotel and our services end at your drop off point.    </p>
                  ...
                  <div class="carousel-inner">
                    ...
                    <div class="carousel-item" data-bs-interval="2000">
                      <div class="row h-100">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="khirsu_2_nights.php"><img class="img-fluid" src="assets/img/gallery/backpacking.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="amarnath_yatra.php"><img class="img-fluid" src="assets/img/gallery/beaches.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="mussoorie_3_nights.php"><img class="img-fluid" src="assets/img/gallery/hill.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                              <h5 class="text-white fs--1">Hill and nature</h5>
                            </div>
                          </div>
