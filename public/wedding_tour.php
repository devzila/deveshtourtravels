...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Devesh Travels: Wedding Transport Bus & Taxi Services &amp; We provide bus and taxi services for 	Wedding Transport.</title>
    ...
    <meta property="og:title" content="Devesh Travels: Wedding Transport Bus & Taxi PACKAGES &amp; We provide bus and taxi services for 	Wedding Transport."/>
    ...
    <meta property="og:image" content="https://deveshtravels.com/assets/img/gallery/images3.jpeg"/>
    <meta property="og:image:width" content="550"/><meta property="og:image:height" content="370"/>
    <meta property="twitter:image" content="https://deveshtravels.com/assets/img/gallery/images3.jpeg"/>
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="10000">
                      <div class="row h-100">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="ad_film_shooting.php"><img class="img-fluid" src="assets/img/gallery/images4.png" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                    ...
                    <div class="carousel-item" data-bs-interval="2000">
                      <div class="row h-100">
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="khirsu_auli_4_nights.php"><img class="img-fluid" src="assets/img/gallery/food.jpeg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="mussoorie_3_nights.php"><img class="img-fluid" src="assets/img/gallery/art-culture.png" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="kumaon_8_nights.php"><img class="img-fluid" src="assets/img/gallery/wild.png" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
